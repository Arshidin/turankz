 ...
 *
 * Trigger matches text input styling:
 * - Height: 36px
 * - Background: bg-input (#1A1A1A)
 * - Border: 1px solid border-default (#3A3A3A)
 * - Border-radius: 6px
 * - Chevron: Right-aligned, 16px, text-tertiary
 *
 * Dropdown menu:
 * - Background: bg-surface-elevated (#242424)
 * - Border-radius: 8px
 * - Shadow: elevated
 * - Option height: 32-36px
 * - Option hover: bg-surface-hover
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "h-[32px] py-1.5 pl-8 pr-2",
      "rounded-[6px]",
      // Typography
      "text-[13px] text-[var(--text-primary)]",
      // States
      "outline-none",
      "focus:bg-[var(--bg-surface-hover)]",
