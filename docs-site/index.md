...
**Welcome to the Turan Standard Pool platform documentation.**

This documentation provides comprehensive, production-ready information about the platform's functionality, roles, business logic, and technical architecture.

## About This Documentation

This documentation is:
- **100% aligned with actual implementation** - No speculative or planned features
- **Bilingual** - Available in English and Russian
- **Institutional-grade** - Suitable for audits, onboarding, and scaling
- **Role-specific** - Clear guidance for Farmers, MPKs, and Admins
